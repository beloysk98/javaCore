...
Владислав: Одинаковые строки хранятся, кроме обьектов
Александр: почитай ещё раз внимательно лекцию про пул строк и дополнительные источники на эту тему. повторно ответь на мой вопрос.
 */
