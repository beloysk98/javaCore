...
public class Proverka {
    ...
    // а теперь подумай как сделать так, чтобы в одном методе был оне больше 20 строк.
    // есть такое правило: если весь код в методе не влазит на экран, значит в этом методе находится говнокод)
    void operator() {
